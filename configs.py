...
class Config(object):
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "6763089308:AAFz0TPyVc7kiZp59fNZxmDGnDmW_4nkLzI")
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "Noobfile_Tbot")
...
"""
  ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿: [VJ](https://telegram.me/l_abani)
 
 I am Super noob Please Support My Hard Work.

[Donate Me](https://t.me/l_abani)
"""
  HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **FileStore Bot**.
